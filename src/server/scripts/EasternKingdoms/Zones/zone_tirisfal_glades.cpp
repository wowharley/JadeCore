        ...
        void DoWork()
        {
            switch (m_phase)
            {
                ...
                case 2:
                    ...
                    {
                        m_npc->SetByteValue(UNIT_FIELD_ANIM_TIER, 0, UNIT_STAND_STATE_KNEEL);
                ...
                case 7:
                    if (m_npc && m_npc->IsAlive())
                    {
                        ...
                        m_npc->SetByteValue(UNIT_FIELD_ANIM_TIER, 0, UNIT_STAND_STATE_STAND);
                    }
                    m_timer = 2500;
                    m_phase = 8;
                    break;
...
public:
    ...
    struct npc_valdred_morayAI : public ScriptedAI
    {
        ...
        void StartAnimation(Player* player)
        {
            ...
            {
                me->RemoveFlag(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP | UNIT_NPC_FLAG_QUESTGIVER);
                me->SetByteValue(UNIT_FIELD_ANIM_TIER, 0, UNIT_STAND_STATE_STAND);
                m_player = player;
                m_phase = 1;
                m_timer = 100;
            }
