...
-- ----------------------------
-- Table structure for `quest_completer`
-- ----------------------------
...
ENGINE=MyISAM
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
COMMENT='Default permission to assign to different account security levels'
...
ENGINE=MyISAM
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
COMMENT='Permission - Linked Permission relation'
...
`name`  varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'JadeCore' ,
...
-- ----------------------------
BEGIN;
INSERT INTO `realmlist` VALUES ('1', 'JadeCore 5.4.8 (Alpha)', '127.0.0.1', '127.0.0.1', '255.255.255.0', '8085', '0', '0', '1', '0', '0', '18414');
COMMIT;
...
`revision`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '5.4.8' ,
...
-- ----------------------------
BEGIN;
INSERT INTO `uptime` VALUES ('1', '1476071147', '0', '0', 'JadeCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win32, Release)');
COMMIT;
...
-- ----------------------------
ALTER TABLE `autobroadcast` AUTO_INCREMENT=1;

-- ----------------------------
-- Auto increment value for `bug_tickets`
-- ----------------------------
ALTER TABLE `bug_tickets` AUTO_INCREMENT=1;
...
-- ----------------------------
-- Indexes structure for table rbac_default_permissions
-- ----------------------------
CREATE INDEX `fk__rbac_default_permissions__rbac_permissions` ON `rbac_default_permissions`(`permissionId`) USING BTREE ;

-- ----------------------------
-- Indexes structure for table rbac_linked_permissions
-- ----------------------------
CREATE INDEX `fk__rbac_linked_permissions__rbac_permissions1` ON `rbac_linked_permissions`(`id`) USING BTREE ;
CREATE INDEX `fk__rbac_linked_permissions__rbac_permissions2` ON `rbac_linked_permissions`(`linkedId`) USING BTREE ;
